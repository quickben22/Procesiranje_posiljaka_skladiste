...
namespace Procesiranje_posiljaka_skladiste.Printing
{
    ...
    partial class BXLLApi
    {
        ...
        public static bool PrintTrueFontLibWithAlignW(int nXPos, int nYPos, string strFontName, int nFontSize, int nRotaion, bool bItalic, bool bBold, bool bUnderline, string strText, int nReserved, int nAlignment, bool bDataCompression)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintTrueFontLibWithAlignW(nXPos, nYPos, strFontName, nFontSize, nRotaion, bItalic, bBold, bUnderline, strText, nReserved, nAlignment, bDataCompression);
            else
                return BXLLApi_x86.PrintTrueFontLibWithAlignW(nXPos, nYPos, strFontName, nFontSize, nRotaion, bItalic, bBold, bUnderline, strText, nReserved, nAlignment, bDataCompression);
        }
        ...
        public static bool PrintImageLibW(int nCodePage, int nHorizontalStartPos, int nVerticalStartPos, string pBitmapFilename, int nDither, bool bDataCompression)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintImageLibW(nCodePage, nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither, bDataCompression);
            else
                return BXLLApi_x86.PrintImageLibW(nCodePage, nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither, bDataCompression);
        }
